...
when 'fedora'
  ...
  when 20
    default['yum']['remi-php70-debuginfo']['baseurl'] = 'http://rpms.remirepo.net/fedora/20/debug-php70/$basearch/'
    default['yum']['remi-php70-debuginfo']['description'] = "Remi's PHP 7.0 RPM repository for Fedora Linux 20 - $basearch - debuginfo"
  when 21
