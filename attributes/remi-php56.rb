...
when 'fedora'
  ...
  when 20
    # default['yum']['remi-php56']['baseurl'] = 'http://rpms.remirepo.net/fedora/20/php56/$basearch/'
    default['yum']['remi-php56']['mirrorlist'] = 'http://rpms.remirepo.net/fedora/20/php56/mirror'
    default['yum']['remi-php56']['description'] = "Remi's PHP 5.6 RPM repository for Fedora Linux 20 - $basearch"
  when 21
